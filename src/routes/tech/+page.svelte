  ...
  <div class="container mx-auto px-4 mb-14">
    <div
      ...
      <img
        ...
        alt="" />
      <div class="flex flex-col justify-start p-3 py-0">
        <h5
          class="mb-1 text-lg font-medium text-neutral-800 dark:text-neutral-50">
          Specifications
        </h5>
        <table class="table-auto text-sm">
          <tbody>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Min casing size    </td>
              <td>4-1/2" (114 mm)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Max casing size</td>
              <td>13-3/8" (341 mm)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Tool o.d.</td>
              <td>3.6" (91.4 mm)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Tool length</td>
              <td>45.3 ft (13.8 m)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Max Pressure</td>
              <td>10,000 psi (68.9 Mpa)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Max Temp</td>
              <td>350 degF (177 degC)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Pump rate</td>
              <td>0.03 - 0.5 gal/min<br> 0.1 - 2.0 l/min</td>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Max pump head</td>
              <td>1000 psi (6.9 Mpa)</td>
            </tr>
            <tr class="odd:bg-gray-100 hover:!bg-stone-200">
              <td class="p-0.5 border-b text-left">Packer spacing</td>
              <td>11 ft (3.4 m) with optional MPL tool (variable)</td>
            </tr>
          </tbody>
        </table>
      </div>
